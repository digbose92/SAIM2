...
base_folder="/data/Multi_Domain_Data/BERT_features_v3"
source_csv_file="/data/Multi_Domain_Data/parsed_csv_data/books/books_review_splits_combined.csv"
#"/proj/digbose92/domain_adapt_data/parsed_csv_data/kitchen_&_housewares/kitchen_&_housewares_review_splits_combined.csv"
target_csv_file="/data/Multi_Domain_Data/parsed_csv_data/kitchen_&_housewares/kitchen_&_housewares_review_splits_combined.csv"
#"/proj/digbose92/domain_adapt_data/parsed_csv_data/dvd/dvd_review_splits_combined.csv"
...
run_history_base_folder="/data/Multi_Domain_Data/BERT_adaptation_features_run_v2"
#"/proj/digbose92/domain_adapt_data/BERT_adaptation_features_run_avalon"
...
for i, zdim in enumerate(zdim_list):
    ...
    classifier = classifierNN(zdim,nofclasses)
    loss=[]
    ...
    classifiersource = classifierNN(zdim,nofclasses)
    classifiersource.set_weights(classifier.get_weights()) 

    print('Beginning adaptation')

    imgY = Input(shape=(1024,), name="input_img")  # adapt this if using `channels_first` image data format
